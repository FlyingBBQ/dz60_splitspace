...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DF] = KEYMAP( KC_GRV  , KC_1    , KC_2    , KC_3   , KC_4    , KC_5   , KC_6    , KC_7    , KC_8  , KC_9    , KC_0     , KC_MINS , KC_EQL  , KC_NO   , KC_BSPC ,
            KC_TAB  , KC_Q    , KC_W    , KC_E   , KC_R    , KC_T   , KC_Y    , KC_U    , KC_I  , KC_O    , KC_P     , KC_LBRC , KC_RBRC , KC_BSLS ,
            KC_ESC  , KC_A    , KC_S    , KC_D   , KC_F    , KC_G   , KC_H    , KC_J    , KC_K  , KC_L    , KC_SCLN  , KC_QUOT , KC_ENT  ,
            KC_LSFT , KC_NO   , KC_Z    , KC_X   , KC_C    , KC_V   , KC_B    , KC_N    , KC_M  , KC_COMM , KC_DOT   , KC_SLSH , KC_RSFT , KC_DEL  ,
            KC_LCTL , KC_LGUI , KC_LALT , KC_SPC , MO(_FN) , KC_SPC , KC_RALT , OSL(_MC), KC_NO , TO(_L1) , KC_RCTL) ,
    ...
    [_L1] = KEYMAP(
            ...
            KC_ESC  , KC_A    , KC_S    , KC_D   , KC_F    , KC_G   , KC_H    , KC_J    , KC_K  , KC_L    , KC_SCLN  , KC_QUOT , KC_ENT  ,
            KC_LSFT , KC_NO   , KC_Z    , KC_X   , KC_C    , KC_V   , KC_B    , KC_N    , KC_M  , KC_COMM , KC_DOT   , KC_SLSH , KC_RSFT , KC_DEL  ,
            KC_LCTL , KC_LGUI , KC_LALT , KC_BSPC, MO(_FN) , KC_SPC , KC_RALT , OSL(_MC), KC_NO , TO(_DF) , KC_RCTL) ,
    ...
    [_FN] = KEYMAP(
            ...
            ______ , ______  , ______  , ______ , ______ , ______ , RGB_VAD , RGB_VAI , ______  , RGB_M_P , RGB_M_B) ,
    [_MC] = KEYMAP(
